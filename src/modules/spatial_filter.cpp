...
CircularQueue::CircularQueue(int cap) : capacity(cap),
                                        queue(capacity),
                                        size(0),
                                        front(0),
                                        rear(-1),
...
SpatialFilter::SpatialFilter(double time_slice, double distance_threshold, int max_map, int parallel, int max_queue_length) : Filter::Filter("SpatialFilter", time_slice, parallel, max_queue_length),
